...
<body>
    ...
    <div id="containerForm">
        <h3>Save customer</h3>
            ...
            <form:form action="savePlayerVip" modelAttribute="player" method="post">
                ...
                <table>
                    <tbody>
                        ...
                        <tr>
                            <td><label>*VIP Code: </label></td>
                            <td><form:input path="status"/> <form:errors path="status" cssClass="error"/>
                            </td>
                        </tr>
                        <tr>
                            <td><label/></td>
